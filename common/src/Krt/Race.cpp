...
Race::Race(Instance &instance) :
	...
	m_fb_depth_buffer(instance.image2D(sb::Format::d24un_or_32sf_spl_att_sfb, {2048, 2048}, 1, sb::Image::Usage::DepthStencilAttachment | sb::Image::Usage::Sampled, instance.graphics)),
	...
	m_fb_depth_range(instance.image2D(sb::Format::rg16_sfloat, {1024, 1024}, sb::Image::allMipLevels, sb::Image::Usage::ColorAttachment | sb::Image::Usage::Sampled, instance.graphics)),
	...
	m_track(instance.create<Track>())
{
	...
	cmd.record([&](auto &cmd){
		cmd.imageMemoryBarrier(sb::PipelineStage::BottomOfPipe, sb::PipelineStage::TopOfPipe, {}, sb::Access::MemoryWrite, sb::Access::MemoryRead, sb::Image::Layout::Undefined, sb::Image::Layout::General, m_fb_depth_range);
	});
...
void Race::run(void)
{
	while (!m_is_done) {
		...
		m_cmd_prim.record([&](auto &cmd){
			...
			cmd.memoryBarrier(sb::PipelineStage::ColorAttachmentOutput | sb::PipelineStage::LateFragmentTests, sb::PipelineStage::FragmentShader, {}, sb::Access::ColorAttachmentWrite | sb::Access::DepthStencilAttachmentWrite, sb::Access::ShaderRead);
